...
**Stand**: @include(date) ([1.0.5](https://github.com/berlinonline/open-data-handbuch/blob/master/CHANGELOG.md#105))

---

![Europäischer Fonds für regionale Entwicklung (EFRE)](images/eu_efre_zusatz_unten.png "Logo und Schriftzug 'Europäischer Fonds für regionale Entwicklung (EFRE)'"){width=102px}\ ![Senatsverwaltung für Wirtschaft, Energie und Betriebe](images/Sen_WiEnBe_Logo_DE_v_p_4C_VORAB.png "Logo und Schriftzug 'Senatsverwaltung für Wirtschaft, Energie und Betriebe'"){width=120px}
