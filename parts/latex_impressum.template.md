...
**Stand**: @include(date) ([1.1.0](https://github.com/berlinonline/open-data-handbuch/blob/master/CHANGELOG.md))

---

![Europäischer Fonds für regionale Entwicklung (EFRE)](images/eu_efre_zusatz_unten.png "Logo und Schriftzug 'Europäischer Fonds für regionale Entwicklung (EFRE)'"){width=102px}\ ![Senatsverwaltung für Inneres, Digitalisierung und Sport](images/B_SEN_InnDS_Logo_DE_V_PW_RGB.png "Logo und Schriftzug 'Senatsverwaltung für Inneres, Digitalisierung und Sport'"){width=120px}
